...
st.set_page_config(page_title="Final Year Project - Neural Style Transfer",
                   page_icon="./assets/favicon.png", layout="centered")

# -------------Header Section------------------------------------------------

title = '<p style="text-align: center;font-size: 50px;font-weight: 350;font-family:Cursive "> Final Year Project - Neural Style Transfer </p>'
...
with st.sidebar:
    ...
    st.markdown('Below are some of the art we created using Neural Style Transfer.',
                unsafe_allow_html=True)
 ...
 # ----------------------------------------------------------------------
    ...
    st.markdown("## Made by **Buvaneshwari** \U0001F609")
    st.markdown("Contribute to this project at "
                "[*github.com/BuvaneshwariC*](https://github.com/BuvaneshwariC/nst-project)")
